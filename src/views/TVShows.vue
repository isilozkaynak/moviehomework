<template>
  <section class="container">
    <div class="container-title">TV Shows</div>
...
export default {
  ...
  setup() {
    ...
    const API_URL =
      BASE_URL +
      "/discover/movie?with_genres=18&sort_by=vote_average.desc&vote_count.gte=2&" +
      API_KEY;
             ...
             <img class="container__list__item-img" src="${
               poster_path
                 ...
                 : "http://via.placeholder.com/255x400"
                   ...
                   <button class="container__list__item container__list__item--add" v-on:click="getMovie()">
